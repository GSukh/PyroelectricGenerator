...
@interface WindowController ()	<CPTPlotDataSource, CPTPlotSpaceDelegate>
...
- (instancetype)init
{
	self = [super init];
	if (self) {
		self = [super initWithNibName:@"WindowController" bundle:nil];
...
//			dispatch_after(dispatch_time(DISPATCH_TIME_NOW, (int64_t)(0.5 * NSEC_PER_SEC)), dispatch_get_main_queue(), ^{
				self.data = [NSMutableArray arrayWithArray:[solver data]];
			[solver show];
